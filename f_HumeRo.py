...
def tela():
    while True:
        ...
        simbolo_1, nome_elemento_1 = elemento.nome_elemento(elemento_1)
        simbolo_2, nome_elemento_2 = elemento.nome_elemento(elemento_2)
        ...
        raio_atomico_1 = 1.0
        raio_atomico_2 = 2.0
        estrutura_cristalina_1 = "CS"
        estrutura_cristalina_2 = "CFC"
        eletronegatividade_1 = 1.0
        eletronegatividade_2 = 2.0
        valencia_1 = 1.0
        valencia_2 = 2.0

        print("Vl novo, ok ou  3 <")
        print("Elemento : "+simbolo_1+" | "+simbolo_2)
        print("Raio aomico: "+str(raio_atomico_1)+" | "+str(raio_atomico_2))
    ...
    print(
        f"2. Estrutura cristalina: {'mesma' if same_crystal_structure else 'diferente'}")
    print("===============================================")
    print("3. Eletronegatividade: Os dois elementos devem ter eletronegatividades semelhantes.")
    print(
        f"3. Diferença de eletronegatividade: {electronegativity_difference:.2f}")
    print("===============================================")
